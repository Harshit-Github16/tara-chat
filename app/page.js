            ...
            <div className="mt-16 text-center">
              <div className="inline-flex items-center gap-4 rounded-2xl bg-white border border-rose-100 p-6 shadow-lg">
                <div className="flex -space-x-2">
                  ...
                  <div className="h-10 w-10 rounded-full bg-pink-200 border-2 border-white flex items-center justify-center text-pink-700 font-semibold text-sm">MC</div>
                  ...
                  <div className="h-10 w-10 rounded-full bg-pink-300 border-2 border-white flex items-center justify-center text-pink-800 font-semibold text-sm">+5K</div>
                </div>
                    ...
                    <div
                      ...
                      className={`h-12 w-12 rounded-full border-3 border-white flex items-center justify-center text-white font-semibold text-sm shadow-lg ${index % 4 === 0 ? 'bg-rose-400' :
                        index % 4 === 1 ? 'bg-pink-400' :
                          index % 4 === 2 ? 'bg-rose-500' : 'bg-pink-500'
                        }`}
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 items-center">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 rounded-lg border border-rose-200 bg-white px-4 py-3 text-gray-900 placeholder-gray-500 focus:border-rose-500 focus:outline-none focus:ring-1 focus:ring-rose-500"
                />
                <button className="rounded-lg bg-rose-200 px-6 py-3 font-semibold text-rose-700 hover:bg-rose-300 transition-all">
                  Subscribe
                </button>
              </div>
            </div>
  ...
  return (
    <div className="relative group">
      <div className="rounded-3xl border border-rose-100 bg-white p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2">
        ...
        {/* Hover effect */}
        <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-rose-500/5 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      </div>
    </div>
  );
}
