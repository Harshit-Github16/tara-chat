...
export default function OnboardingPage() {
    ...
    const handleNext = () => {
        if (currentStep < 3) {
            ...
            // Save user data and redirect to welcome
                ...
                <div className="bg-white rounded-2xl border border-rose-100 shadow-lg p-8">
                    ...
                    <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                        ...
                        <button
                            ...
                            className={`inline-flex items-center gap-2 px-8 py-3 rounded-lg font-semibold transition-all ${isStepValid()
                                ? 'bg-rose-200 text-rose-700 hover:bg-rose-300 shadow-lg'
