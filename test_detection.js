...
function detectLanguage(message) {
    ...
    const hindiWords = [
        'hai', 'hain', 'houn', 'hun', 'tha', 'thi', 'the', // verbs
        'ka', 'ki', 'ke', 'ko', 'ne', 'se', 'me', 'mein', 'par', 'pe', // prepositions
        'main', 'hum', 'tum', 'aap', 'tu', // pronouns
        'kya', 'kyun', 'kab', 'kahan', 'kaise', 'kaun', 'kisko', 'kisne', // questions
        'nahi', 'nahin', 'na', 'mat', // negatives
        'haan', 'ji', 'han', // affirmatives
        'acha', 'accha', 'achha', 'bura', 'kharab', // adjectives
        'bahut', 'bohot', 'jyada', 'kam', // quantifiers
        'kuch', 'koi', 'sab', 'sabhi', // quantifiers
        'yaar', 'bhai', 'dost', 'bro', // address
        'kar', 'karo', 'karna', 'kiya', 'krrhi', 'krra', 'karunga', 'karungi', // do verbs
        'raha', 'rahi', 'rahe', // continuous markers
        'gaya', 'gayi', 'gaye', // past markers
        'kal', 'aaj', 'abhi', 'jab', 'tab', // time
...
const messages = [
    ...
    "kya hal hai",
    "tu kaisa hai",
    "start fresh",  // Should be English
    "I am good",     // Should be English
    "Main theek hoon" // Should be Hinglish
];

messages.forEach(msg => {
    console.log(`Msg: "${msg}" -> Result: ${detectLanguage(msg)}`);
});
